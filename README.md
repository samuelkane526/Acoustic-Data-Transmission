...
Using the ___BIN_SPACING___ value we already got, we assign uniuqe values each __BIN_SPACING*2__ apart. Our ___BASE_FREQUENCY___ is 1000hz, so our first data signal is assigned to 1000hz, and our second 1023.43hz. There are 259 total signals we need to repersent, meaning we go up to 6976hz with the defualt values.

Signal Types:
HELLO: Tells the program to start analyzing audio. (__bin_width*26__)
